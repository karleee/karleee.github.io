// Object constructor for a particle
function Particle(x, y, radius) {
  this.init(x, y, radius);
}

// Adding methods to the all particle objects via prototype
Particle.prototype = {
...
// Create a new sketch with the div labeled with an id of container
var demo = Sketch.create({container: document.getElementById('container')});

demo.setup = function () {
  // Set off initial particles in the center of the page
  var i, x, y;
...
// Function to move particles with the mouse
